...
public class FragmentSideMenuBindingImpl extends FragmentSideMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.fragmentSide == variableId) {
            setFragmentSide((com.example.lunchtray.ui.order.SideMenuFragment) variable);
        }
    ...
    public void setFragmentSide(@Nullable com.example.lunchtray.ui.order.SideMenuFragment FragmentSide) {
        this.mFragmentSide = FragmentSide;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
        notifyPropertyChanged(BR.fragmentSide);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.ui.order.SideMenuFragment fragmentSide = mFragmentSide;
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            ...
            case 5: {
                // localize variables for thread safety
                // fragmentSide != null
                boolean fragmentSideJavaLangObjectNull = false;
                // fragmentSide
                com.example.lunchtray.ui.order.SideMenuFragment fragmentSide = mFragmentSide;



                fragmentSideJavaLangObjectNull = (fragmentSide) != (null);
                if (fragmentSideJavaLangObjectNull) {


                    fragmentSide.cancelOrder();
                }
                break;
            }
            case 2: {
