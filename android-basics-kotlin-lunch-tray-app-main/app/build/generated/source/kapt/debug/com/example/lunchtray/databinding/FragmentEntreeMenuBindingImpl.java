...
public class FragmentEntreeMenuBindingImpl extends FragmentEntreeMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.fragmentEntree == variableId) {
            setFragmentEntree((com.example.lunchtray.ui.order.EntreeMenuFragment) variable);
        }
    ...
    public void setFragmentEntree(@Nullable com.example.lunchtray.ui.order.EntreeMenuFragment FragmentEntree) {
        this.mFragmentEntree = FragmentEntree;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
        notifyPropertyChanged(BR.fragmentEntree);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.ui.order.EntreeMenuFragment fragmentEntree = mFragmentEntree;
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            ...
            case 6: {
                ...
                com.example.lunchtray.ui.order.EntreeMenuFragment fragmentEntree = mFragmentEntree;
                // fragmentEntree != null
                boolean fragmentEntreeJavaLangObjectNull = false;



                fragmentEntreeJavaLangObjectNull = (fragmentEntree) != (null);
                if (fragmentEntreeJavaLangObjectNull) {


                    fragmentEntree.goToNextScreen();
                }
                break;
            }
            case 3: {
