...
public abstract class FragmentEntreeMenuBinding extends ViewDataBinding {
  ...
  @Bindable
  protected EntreeMenuFragment mFragmentEntree;
  ...
  public abstract void setFragmentEntree(@Nullable EntreeMenuFragment fragmentEntree);

  @Nullable
  public EntreeMenuFragment getFragmentEntree() {
    return mFragmentEntree;
  }
