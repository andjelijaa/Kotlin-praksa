...
public abstract class FragmentSideMenuBinding extends ViewDataBinding {
  ...
  @Bindable
  protected SideMenuFragment mFragmentSide;
  ...
  public abstract void setFragmentSide(@Nullable SideMenuFragment fragmentSide);

  @Nullable
  public SideMenuFragment getFragmentSide() {
    return mFragmentSide;
  }
